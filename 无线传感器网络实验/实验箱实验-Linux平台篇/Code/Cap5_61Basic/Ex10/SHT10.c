...
void I2c_Init(void)
{
	*I2C_Dir |= (I2C_D | I2C_C );//| I2C_RST
	*I2C_Attrib &= ~(I2C_D | I2C_C );//| I2C_RST
	*I2C_Buffer &= ~(I2C_C | I2C_D);
...
{
	return (65 * dat) - 400 - ((295 * (unsigned long)dat * (unsigned long)dat) >> 12);
//	return (648 * dat - 4000) - (unsigned int)(((unsigned long)(dat * dat * 72)) / 100);
}
