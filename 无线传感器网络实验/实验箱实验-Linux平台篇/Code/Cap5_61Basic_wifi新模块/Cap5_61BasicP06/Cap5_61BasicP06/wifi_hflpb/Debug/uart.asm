...
// Command: C:\GENERA~1\UNSPID~1.4\toolchain\cc1.exe C:\Users\XIANGX~1.LIU\AppData\Local\Temp\ccuFGaLz.i -fkeep-inline-functions -quiet -dumpbase uart.c -mglobal-var-iram -gstabs -Wall -o .\Debug/uart.asm
...
.code
.debug
	.dw '.stabs "C:/Users/xiangxiang.liu/Desktop/wifi_hflpb/wifi_drv/uart.c",0x64,0,3,',0,0,offset Ltext0,seg Ltext0,0x0d,0x0a
.code
.code
Ltext0:
.debug
...
.CODE
.debug
	.dw '.stabs "UART_INFO:G33=s1ProcessRxByte:34=*35=f19,0,16;;",32,0,0,',0,0,offset _UART_INFO,seg _UART_INFO,0x0d,0x0a
.CODE
.code
.debug
...
.debug
	.dw '.stabs "ProcessRxByte:p34",160,0,0,3',0x0d,0x0a
.CODE
.debug
	.dw '.stabf ',0,0
	.dd LME1-_UART_Init
...
_BaudRateTable:
	...
	.dw 107
.debug
	.dw '.stabs "BaudRateTable:S36=ar1;0;12;4",38,0,0,',0,0,offset _BaudRateTable,seg _BaudRateTable,0x0d,0x0a
.CODE
.code
.debug
...
.debug
	.dw '.stabs "nBaudRate:p32",160,0,0,3',0x0d,0x0a
.CODE
.debug
	.dw '.stabf ',0,0
...
.debug
	.dw '.stabs "buf:p37=*19",160,0,0,5',0x0d,0x0a
.CODE
.debug
...
.code
.debug
	.dw '.stabs "p:38=*11",128,0,0,0',0x0d,0x0a
.CODE
.debug
...
.debug
	.dw '.stabs "str:p39=*2",160,0,0,3',0x0d,0x0a
.CODE
.debug
	.dw '.stabf ',0,0
