...
// Command: C:\GENERA~1\UNSPID~1.4\toolchain\cc1.exe C:\Users\XIANGX~1.LIU\AppData\Local\Temp\cc2gQyD8.i -fkeep-inline-functions -quiet -dumpbase SystemTime.c -mglobal-var-iram -gstabs -Wall -o .\Debug/SystemTime.asm
...
.code
.debug
	.dw '.stabs "C:/Users/xiangxiang.liu/Desktop/wifi_hflpb/SystemTime.c",0x64,0,3,',0,0,offset Ltext0,seg Ltext0,0x0d,0x0a
.code
.code
Ltext0:
.debug
...
.CODE
.debug
	.dw '.stabs "BYTE:t23=11",128,0,0,0',0x0d,0x0a
.CODE
.debug
	.dw '.stabs "PBYTE:t24=25=*11",128,0,0,0',0x0d,0x0a
.CODE
.debug
	.dw '.stabs "WORD:t26=4",128,0,0,0',0x0d,0x0a
.CODE
.debug
	.dw '.stabs "PWORD:t27=28=*4",128,0,0,0',0x0d,0x0a
.CODE
.debug
	.dw '.stabs "DWORD:t29=5",128,0,0,0',0x0d,0x0a
.CODE
.debug
	.dw '.stabs "PDWORD:t30=31=*5",128,0,0,0',0x0d,0x0a
.CODE
.debug
	.dw '.stabs "PVOID:t32=33=*19",128,0,0,0',0x0d,0x0a
.CODE
.debug
	.dw '.stabs "size_t:t34=4",128,0,0,0',0x0d,0x0a
.CODE
.debug
	.dw '.stabs "ssize_t:t35=1",128,0,0,0',0x0d,0x0a
.CODE
.debug
	.dw '.stabs "_sysTick:S5",40,0,0,',0,0,offset __sysTick,seg __sysTick,0x0d,0x0a
.CODE
.iram
_waitQueue:
	.dw 0
.debug
	.dw '.stabs "waitQueue:S36=*22",38,0,0,',0,0,offset _waitQueue,seg _waitQueue,0x0d,0x0a
.CODE
.code
.debug
...
.code
.debug
	.dw '.stabs "prev:36",128,0,0,0',0x0d,0x0a
.CODE
.debug
	.dw '.stabs "cur:36",128,0,0,1',0x0d,0x0a
.CODE
.debug
...
.debug
	.dw '.stabs "info:p36",160,0,0,15',0x0d,0x0a
.CODE
.debug
...
.debug
	.dw '.stabs "info:p36",160,0,0,3',0x0d,0x0a
.CODE
.debug
	.dw '.stabf ',0,0
...
.debug
	.dw '.stabs "info:p36",160,0,0,6',0x0d,0x0a
.CODE
.debug
	.dw '.stabn 0xc0,0,0,',0,0
