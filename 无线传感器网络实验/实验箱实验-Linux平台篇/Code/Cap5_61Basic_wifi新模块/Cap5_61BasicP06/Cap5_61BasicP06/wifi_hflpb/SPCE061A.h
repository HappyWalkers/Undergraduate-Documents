...
typedef void *PVOID;
#define LWORD(DWORD) ((unsigned int)(*((unsigned int *)(&DWORD))))				//	取出long型数据的低字
#define HWORD(DWORD) ((unsigned int)(*((unsigned int *)(&DWORD) + 1)))			//	取出long型数据的高字
...
//	Constants for SIO
	...
	#define 	C_SIO_CLOCK_4			0x0008 		// P_SIO_Ctrl
