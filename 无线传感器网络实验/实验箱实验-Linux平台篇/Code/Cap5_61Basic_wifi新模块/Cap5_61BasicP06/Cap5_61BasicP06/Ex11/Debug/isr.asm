...
// Command: C:\GENERA~1\UNSPID~1.4\toolchain\cc1.exe C:\Users\XIANGX~1.LIU\AppData\Local\Temp\ccFJ0po7.i -fkeep-inline-functions -quiet -dumpbase isr.c -mglobal-var-iram -gstabs -Wall -o .\Debug/isr.asm
...
.code
.debug
	.dw '.stabs "C:/Users/xiangxiang.liu/Desktop/Ex11/isr.c",0x64,0,3,',0,0,offset Ltext0,seg Ltext0,0x0d,0x0a
.code
.code
Ltext0:
.debug
...
.CODE
.debug
	.dw '.stabs "valueString:G33=ar1;0;19;11",32,0,0,',0,0,offset _valueString,seg _valueString,0x0d,0x0a
.CODE
.public _ShakeSensorFlag
.iram
_ShakeSensorFlag:
	.dw 1
.debug
	.dw '.stabs "ShakeSensorFlag:G11",32,0,0,',0,0,offset _ShakeSensorFlag,seg _ShakeSensorFlag,0x0d,0x0a
.CODE
.text
LC0:
	.str 'S', 'h', 'a', 'k', 'e', ':', '%', '0', '2', 'd', 10, 0
	// length = 12
...
.text
LM6:
	CALL _ShakeRefresh	// call with return value
	CMP R1,0	// QImode test
	NSJNZ L5	//QImode NE
.debug
...
LM7:
	R1=0	// QImode move
	[_ShakeSensorFlag]=R1	// QImode move
.debug
...
.text
LM8:
	R1=[_ShakeSensorFlag]	// QImode move
	[SP--]=R1	// QImode move
	R1=LC0	// QImode move
	[SP--]=R1	// QImode move
	R1=_valueString	// QImode move
	[SP--]=R1	// QImode move
