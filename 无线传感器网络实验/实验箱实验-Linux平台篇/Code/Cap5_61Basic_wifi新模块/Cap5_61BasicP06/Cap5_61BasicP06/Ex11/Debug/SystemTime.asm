...
// Command: C:\GENERA~1\UNSPID~1.4\toolchain\cc1.exe C:\Users\XIANGX~1.LIU\AppData\Local\Temp\ccgmcGSk.i -fkeep-inline-functions -quiet -dumpbase SystemTime.c -mglobal-var-iram -gstabs -Wall -o .\Debug/SystemTime.asm
...
.code
.debug
	.dw '.stabs "C:/Users/xiangxiang.liu/Desktop/Ex11/wifi/SystemTime.c",0x64,0,3,',0,0,offset Ltext0,seg Ltext0,0x0d,0x0a
.code
.code
Ltext0:
.debug
