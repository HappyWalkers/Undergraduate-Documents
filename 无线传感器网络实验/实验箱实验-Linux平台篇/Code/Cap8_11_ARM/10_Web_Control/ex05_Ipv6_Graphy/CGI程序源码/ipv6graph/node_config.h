...
enum {
    DevTemp = 1,
    DevHumm,
    DevILLum,		//DevGas,//modify by liucm
    
    DevRain,
    DevIRDist,
    DevGas,		//DevILLum,//modify by liucm
...
static const NODE_TYPE_STRING ipv6comm_nodeTypeList[] = {
    ...
    { DevRouter, "路由", },
    { DevCoordinator, "中心节点",},//"\xE5\x8D\x8F\xE8\xB0\x83\xE5\x99\xA8", },//"协调器", },
};
const char *ipv6comm_find_nodeTypeString(int type)
{
    int left = 0;
...
#endif
#else
externC const char *ipv6comm_find_nodeTypeString(int type);
#endif
