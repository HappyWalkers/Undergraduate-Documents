...
//#define SBP_START_DEVICE_EVT                              0x0001//启动设备
//#define SBP_PERIODIC_EVT                                  0x0002//周期事件
//#define SBP_ADV_IN_CONNECTION_EVT                         0x0004//连接状态、继续广播
...
//  {
////  if((cmdMsg->msg[1] == '@')&&(cmdMsg->msg[len])== '#')
//  {
...
//      osal_memcpy(req.pValue, cmdMsg->msg, SIMPLEPROFILE_CHAR6_LEN );      
//      GATT_WriteLongCharValue(simpleBLEConnHandle, &req, simpleBLETaskId );
...
//  else
//  {
//    HalUARTWrite(HAL_UART_PORT_0,"TheDataError\n",sizeof("TheDataError\n"));
//  }   
}
