...
public class client {
    ...
    public class ancestor extends JFrame {//祖先类，完成页面的基本设置，和socket连接，流的打开
    ...
    public class register extends ancestor implements ActionListener, FocusListener {//注册界面
    ...
    public class mainInterface extends ancestor implements ActionListener, Runnable {//聊天主界面
    ...
    public class makefriend extends ancestor {//添加好友
    ...
    public class listfriend extends ancestor {//查看好友列表
    ...
    public class chatfriend extends ancestor implements ListSelectionListener {//查看在线好友
        protected JTable jTable = null;
        protected JScrollPane jScrollPane = null;
        protected Vector<Vector<String>> data = new Vector<>();
        protected Vector<String> columnName = new Vector<>();
    ...
    public class chatprivate extends mainInterface {//与好友私聊
