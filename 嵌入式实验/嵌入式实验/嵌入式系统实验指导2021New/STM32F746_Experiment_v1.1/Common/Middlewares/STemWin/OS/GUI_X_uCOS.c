...
{ 
  ...
  OSMutexCreate(&osMutex, "OS Mutex", &os_err);
  
  /* Create the Semaphore used by the two threads */
	OSSemCreate(&osSemaphore, "OS Semaphore", 1u, &os_err);
}
//void GUI_X_InitOS(void)
//{ 
//  /* Create Mutex lock */
...
{ 
  OS_ERR os_err;
	OSMutexPost(&osMutex, OS_OPT_POST_NONE, &os_err);
}
//void GUI_X_Unlock(void)
//{ 
...
{
  OS_ERR os_err;
	OSMutexPend(&osMutex, 0, OS_OPT_PEND_BLOCKING, 0, &os_err);
}
//void GUI_X_Lock(void)
//{
...
{
  OS_ERR os_err;
	OSSemPend(&osSemaphore, 0, OS_OPT_PEND_BLOCKING, 0, &os_err);
}
//void GUI_X_WaitEvent (void) 
//{
...
{
  OS_ERR os_err;
	OSSemPost(&osSemaphore, OS_OPT_POST_1, &os_err);
}
//void GUI_X_SignalEvent (void) 
//{
