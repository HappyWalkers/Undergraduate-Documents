clc
clear all
[xdata,textdata]=xlsread('C:\Users\anhuishuangqiao\Desktop\数学实验与建模\数学实验与建模 课件\4 第23讲 神经网络算法 0.5\第23讲 exp12_3_1.xls'); %加载20个城市的数据，数据按照表格中的位置保存在Excel文件exp12_3_1.xls中
