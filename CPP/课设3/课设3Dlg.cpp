// 课设3Dlg.cpp : implementation file
//
...
BOOL CMy3Dlg::OnInitDialog()
{
	...
	m_list.InsertColumn(1,"抄表日期",LVCFMT_CENTER,100);
	m_list.InsertColumn(2,"楼栋号",LVCFMT_CENTER,100);
...
void CMy3Dlg::OnClickList1(NMHDR* pNMHDR, LRESULT* pResult) 
{
	...
	ifstream f2("F:\\C++\\课设3\\f1.txt",ios::in|ios::nocreate);
	char name[20];
	int date;
	int unit;
	double number;
...
void CMy3Dlg::OnButton1() 
{
	...
	ofstream f1("F:\\C++\\课设3\\f1.txt",ios::app);
	UpdateData(true);
